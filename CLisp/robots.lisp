(defun robots ()
  "Play the classic game of Robots! All robots move towards the player. Robot collisions cause scrap that is deadly to other robots. Teleport as a last resort!"
  (loop named main
